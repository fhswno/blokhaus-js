...
export default function Page() {
  return (
    <EditorRoot namespace="youtube-editor" className="min-h-[500px] p-4 border rounded-lg">
      <EditorWithYouTube />
    </EditorRoot>
  );
}
...
export default function Page() {
  return (
    <EditorRoot namespace="timestamp-editor" className="min-h-[500px] p-4 border rounded-lg">
      <EditorWithTimestamp />
    </EditorRoot>
  );
}
...
function useTemplateSlashItems(): SlashMenuItem[] {
  ...
  return [
    ...
    },
    {
      ...
      keywords: ['template', 'spec', 'product', 'prd', 'requirements', 'specification'],
      onSelect: () => {
        insertTemplate(() => {
          const root = $getRoot();
...
export default function Page() {
  return (
    <EditorRoot namespace="template-editor" className="min-h-[500px] p-4 border rounded-lg">
      <EditorWithTemplates />
    </EditorRoot>
  );
}
...
export default function Page() {
  return (
    <EditorRoot namespace="api-editor" className="min-h-[500px] p-4 border rounded-lg">
      <EditorWithApiData />
    </EditorRoot>
  );
}
...
export default function Page() {
  return (
    <main className="max-w-3xl mx-auto py-12 px-4">
      <h1 className="text-2xl font-bold mb-6">Editor with Custom Slash Items</h1>
      <EditorRoot
