...
- A `2px solid` line in the `--scribex-ring` color replaces the default `1px solid` `--scribex-border` line.
...
- **Default state**: `1px solid` using the `--scribex-border` CSS variable.
- **Selected state**: `2px solid` using the `--scribex-ring` CSS variable.
