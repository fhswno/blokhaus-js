...
const customFonts: FontFamilyEntry[] = [
  ...
  { label: 'Courier', value: '"Courier New", monospace', preview: '"Courier New", monospace' },
  { label: 'Comic Sans', value: '"Comic Sans MS", cursive', preview: '"Comic Sans MS", cursive' },
];
...
const googleFonts: FontFamilyEntry[] = [
  { label: 'Default', value: '', preview: 'system-ui, sans-serif' },
  { label: 'Inter', value: '"Inter", sans-serif', preview: '"Inter", sans-serif' },
  { label: 'Playfair Display', value: '"Playfair Display", serif', preview: '"Playfair Display", serif' },
  { label: 'JetBrains Mono', value: '"JetBrains Mono", monospace', preview: '"JetBrains Mono", monospace' },
];
```
