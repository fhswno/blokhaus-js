...
import { EditorRoot, CalloutPlugin, InputRulePlugin, SlashMenu } from '@scribex/core';
...
<Callout type="warn">
When providing custom `presets`, the built-in presets are completely replaced. If you want to extend the defaults, import `DEFAULT_CALLOUT_PRESETS` from `@scribex/core` and spread it into your custom array.
</Callout>
