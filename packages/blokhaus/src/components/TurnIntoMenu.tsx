  ...
  return createPortal(
    <div
      ...
      style={{
        ...
        padding: "4px",
        borderRadius: "12px",
        border: "1px solid var(--blokhaus-popover-border, rgba(0,0,0,0.06))",
        ...
        maxHeight: "340px",
        overflowY: "auto",
        animation: "blokhaus-turn-into-enter 0.15s ease-out",
      }}
    >
      {/* Header */}
      <div
            ...
            onMouseEnter={(e) => {
              if (!isActive) {
                e.currentTarget.style.backgroundColor =
                  "var(--blokhaus-hover-bg, rgba(0,0,0,0.04))";
              }
            }}
            onMouseLeave={(e) => {
          ...
          >
            ...
            {isActive && (
              <CheckIcon
                size={14}
                weight="bold"
                style={{ color: "var(--blokhaus-accent, #3b82f6)" }}
              />
            )}
          </button>
        );
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            @keyframes blokhaus-turn-into-enter {
              from {
                opacity: 0;
