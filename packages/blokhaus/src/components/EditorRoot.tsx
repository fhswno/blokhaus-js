...
// THEME
import { blokhausTheme } from "../theme";
...
const defaultOnError = (error: Error) => {
  console.error("[Blokhaus] Lexical error:", error);
  throw error;
};
...
export function EditorRoot({
  ...
  return (
    <LexicalComposer initialConfig={initialConfig}>
      <div className={className} dir={dir} data-blokhaus-root data-namespace={namespace}>
        <RichTextPlugin
          contentEditable={
            <ContentEditable
              aria-label="Editor content"
              aria-placeholder={placeholder}
              className="blokhaus-content-editable focus:outline-none"
              placeholder={
                <div className="blokhaus-placeholder">
                  {placeholder}
                </div>
              }
            />
