    ...
    return (
      <div
        ...
        style={{
          ...
          animation: "blokhaus-link-enter 0.15s ease-out",
          minWidth: "300px",
        }}
      >
        <LinkIcon size={14} style={{ color: "var(--blokhaus-text-tertiary)", flexShrink: 0 }} />
        <input
          ref={ref}
          type="text"
          value={value}
        ...
        <button
          ...
          style={{
            ...
            color: value.trim() ? "var(--blokhaus-accent-foreground, #fff)" : "var(--blokhaus-text-tertiary)",
            fontSize: "12px",
            fontWeight: 500,
            fontFamily: "inherit",
  ...
  return (
    <div
      ...
      style={{
        ...
        fontFamily:
          '-apple-system, BlinkMacSystemFont, "SF Pro Text", system-ui, sans-serif',
        animation: "blokhaus-link-preview-enter 0.12s ease-out",
      }}
    >
      <a
        href={url}
      ...
      <button
        ...
        style={{
          ...
          cursor: "pointer",
          backgroundColor: "transparent",
          color: "var(--blokhaus-icon-secondary)",
        }}
      >
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            @keyframes blokhaus-link-preview-enter {
              from {
                opacity: 0;
