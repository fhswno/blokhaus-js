    ...
    return (
      <div
        ...
        style={{
          ...
          animation: "blokhaus-prompt-enter 0.2s ease-out",
          minWidth: "320px",
        }}
      >
        <input
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: value.trim()
              ? "var(--blokhaus-ai-stream, #3366cc)"
              : "rgba(51, 102, 204, 0.15)",
            color: value.trim() ? "var(--blokhaus-accent-foreground, #fff)" : "rgba(51, 102, 204, 0.35)",
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `
              @keyframes blokhaus-prompt-enter {
                from {
                  opacity: 0;
